...
#define GET_COMBOPOSREF debug_get_ref(REFCOMBOPOS)
#define GET_COMBOSREF debug_get_ref(REFCOMBOS)
#define GET_COMBOTRIGREF debug_get_ref(REFCOMBOTRIG)
#define GET_DIRECTORYREF debug_get_ref(REFDIRECTORY)
#define GET_DMAPREF debug_get_ref(REFDMAP)
#define GET_DROPSETREF debug_get_ref(REFDROPSET)
#define GET_EWPN debug_get_ref(REFEWPN)
...
#define GET_GUYREF debug_get_ref(REFGUY)
#define GET_ITEMCLASSREFF debug_get_ref(REFIDATA)
#define GET_ITEMREF debug_get_ref(REFITEM)
#define GET_LWPN debug_get_ref(REFLWPN)
#define GET_MAPREF debug_get_ref(REFMAP)
...
#define GET_SAVEPORTALREF debug_get_ref(REFSAVEPORTAL)
#define GET_SCREENREF debug_get_ref(REFSCREEN)
#define GET_SHOPSREF debug_get_ref(REFSHOPS)
...
#define GET_SUBDATAREF debug_get_ref(REFSUBDATA)
#define GET_SUBPAGEREF debug_get_ref(REFSUBPAGE)
#define GET_SUBWIDGREF debug_get_ref(REFSUBWIDG)
#define GET_WEBSOCKETREF debug_get_ref(REFWEBSOCKET)
#define GET_ZMSGREF debug_get_ref(REFZMSG)
...
#define GET_BITMAPREF (ri->bitmapref)
#define GET_BOTTLESHOPREF (ri->bottleshopref)
#define GET_BOTTLETYPEREF (ri->bottletyperef)
#define GET_COMBOPOSREF (ri->comboposref)
#define GET_COMBOSREF (ri->combosref)
#define GET_COMBOTRIGREF (ri->combotrigref)
#define GET_DIRECTORYREF (ri->directoryref)
#define GET_DMAPREF (ri->dmapref)
#define GET_DROPSETREF (ri->dropsetref)
#define GET_EWPN (ri->ewpn)
#define GET_FFCREF (ri->ffcref)
#define GET_FILEREF (ri->fileref)
#define GET_GENERICDATAREF (ri->genericdataref)
#define GET_GUYREF (ri->guyref)
#define GET_ITEMCLASSREFF (ri->itemclassref)
#define GET_ITEMREF (ri->itemref)
#define GET_LWPN (ri->lwpn)
#define GET_MAPSREF (ri->mapsref)
#define GET_NPCDATAREF (ri->npcdataref)
#define GET_PALDATAREF (ri->paldataref)
#define GET_PORTALREF (ri->portalref)
#define GET_RNGREF (ri->rngref)
#define GET_SAVEPORTALREF (ri->saveportalref)
#define GET_SCREENREF (ri->screenref)
#define GET_SHOPSREF (ri->shopsref)
#define GET_SPRITEDATAREF (ri->spritedataref)
#define GET_SPRITEREF (ri->spriteref)
#define GET_STACKREF (ri->stackref)
#define GET_SUBDATAREF (ri->subdataref)
#define GET_SUBPAGEREF (ri->subpageref)
#define GET_SUBWIDGREF (ri->subwidgref)
#define GET_WEBSOCKETREF (ri->websocketref)
#define GET_ZMSGREF (ri->zmsgref)
