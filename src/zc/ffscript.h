...
#define GET_DROPSETREF debug_get_ref(REFDROPS)
...
#define GET_ITEMCLASSREF debug_get_ref(REFITEMCLASS)
...
#define GET_NPCDATAREF debug_get_ref(REFNPCCLASS)
...
#define GET_SCREENREF debug_get_ref(REFSCREENDATA)
...
#define GET_SUBDATAREF debug_get_ref(REFSUBSCREEN)
