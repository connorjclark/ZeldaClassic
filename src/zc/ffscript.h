...
#define GET_COMBOREF debug_get_ref(REFCOMBOS)
...
#define GET_ITEMCLASSREF debug_get_ref(REFIDATA)
...
#define GET_BITMAPREF (ri->bitmapref+0)
#define GET_BOTTLESHOPREF (ri->bottleshopref+0)
#define GET_BOTTLETYPEREF (ri->bottletyperef+0)
#define GET_COMBOPOSREF (ri->comboposref+0)
#define GET_COMBOREF (ri->comboref+0)
#define GET_COMBOTRIGREF (ri->combotrigref+0)
#define GET_DIRECTORYREF (ri->directoryref+0)
#define GET_DMAPREF (ri->dmapref+0)
#define GET_DROPSETREF (ri->dropsetref+0)
#define GET_EWPNREF (ri->ewpnref+0)
#define GET_FFCREF (ri->ffcref+0)
#define GET_FILEREF (ri->fileref+0)
#define GET_GENERICDATAREF (ri->genericdataref+0)
#define GET_GUYREF (ri->guyref+0)
#define GET_ITEMCLASSREF (ri->itemclassref+0)
#define GET_ITEMREF (ri->itemref+0)
#define GET_LWPNREF (ri->lwpnref+0)
#define GET_MAPREF (ri->mapref+0)
#define GET_NPCDATAREF (ri->npcdataref+0)
#define GET_PALDATAREF (ri->paldataref+0)
#define GET_PORTALREF (ri->portalref+0)
#define GET_RNGREF (ri->rngref+0)
#define GET_SAVEPORTALREF (ri->saveportalref+0)
#define GET_SCREENREF (ri->screenref+0)
#define GET_SHOPSREF (ri->shopsref+0)
#define GET_SPRITEDATAREF (ri->spritedataref+0)
#define GET_SPRITEREF (ri->spriteref+0)
#define GET_STACKREF (ri->stackref+0)
#define GET_SUBDATAREF (ri->subdataref+0)
#define GET_SUBPAGEREF (ri->subpageref+0)
#define GET_SUBWIDGREF (ri->subwidgref+0)
#define GET_WEBSOCKETREF (ri->websocketref+0)
#define GET_ZMSGREF (ri->zmsgref+0)
