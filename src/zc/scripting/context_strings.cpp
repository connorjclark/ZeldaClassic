...
const char* scripting_get_zasm_register_context_string(int reg)
{
	switch (reg)
	{
		...
		case GRAPHICS_SPRITE_LAYER_TARGET: return "Graphics->SpriteLayerTarget";
		...
		case HEROFORCEDRESPAWN: return "Hero->ForcedHazardRespawn";
		...
		case HERO_HAMMER_POS: return "Hero->HammerPos";
		...
		case HERORESPAWNDMSCR: return "Hero->RespawnDMapScreen";
		...
		case HERO_TMP_STEPBOOST: return "Hero->TempStepBoost";
		...
		case SCREENCOMBOPOSSTATE: return "Screen->PosState[]";
		...
		case COMBOD_LARGECOMBO_DIRS: return "combodata::LargeComboDirs[]";
		...
		case COMBODATA_LIFT_WEAPONDATA: return "combodata::LiftWeaponData";
		case COMBODLIFTWEAPONITEM: return "combodata::LiftWeaponItem";
		case COMBODATA_MISC_WEAPONDATA: return "combodata::MiscWeaponData";
		...
		case CMBTRIGGER_CHANCE_NUMERATOR: return "combotrigger::ChanceNumerator";
		case CMBTRIGCHANGECMB: return "combotrigger::ComboChange";
		case CMBTRIGPOSSTATE: return "combotrigger::ComboPosState";
		...
		case CMBTRIG_REQ_SCREXDOOR: return "combotrigger::GetReqExDoor()";
		case CMBTRIG_UNREQ_SCREXDOOR: return "combotrigger::GetUnreqExDoor()";
		...
		case CMBTRIG_LARGECOMBO_COPYCAT: return "combotrigger::LargeComboCopycatID";
		...
		case CMBTRIGGER_SFX_FREQUENCY: return "combotrigger::SFXFrequency";
		case CMBTRIGGER_SFX_PAN: return "combotrigger::SFXPan";
		case CMBTRIGGER_SFX_VOLUME: return "combotrigger::SFXVolume";
		...
		case CMBTRIGGER_VIEWPORT_RANGE: return "combotrigger::ViewportRange";
		...
		case DMAPDATASUBSCRM: return "dmapdata::MapSubscreen";
		...
		case DMAPDATAPSUBINITD: return "dmapdata::PassiveSubInitD[]";
		...
		case EWPNBURNLIGHTOFFSET: return "eweapon::BurnLightOffset[]";
		...
		case EWPN_NO_TRIGGERS: return "eweapon::DisableTriggers";
		...
		case FFC_POSSTATE: return "ffc::PosState[]";
		...
		case IDATACOLLECTINITD: return "itemdata::PickupInitD[]";
		...
		case IDATASPRITEINITD: return "itemdata::SpriteInitD[]";
		...
		case IDATA_WEAPONDATA: return "itemdata::WeaponData";
		...
		case ITEMPICKUPEXSTATE: return "itemsprite::PickupExState";
		...
		case LWPNBURNLIGHTOFFSET: return "lweapon::BurnLightOffset[]";
		...
		case LWPN_NO_TRIGGERS: return "lweapon::DisableTriggers";
		...
		case MAPDATAFFCPOSSTATE: return "mapdata::FFCPosState[]";
		...
		case MAPDATACOMBOPOSSTATE: return "mapdata::PosState[]";
		...
		case MESSAGEDATA_ICON_MORE_ANCHOR: return "messagedata::MoreIconAnchor";
		case MESSAGEDATA_ICON_MORE_SPRITE: return "messagedata::MoreIconSprite";
		case MESSAGEDATA_ICON_MORE_X: return "messagedata::MoreIconX";
		case MESSAGEDATA_ICON_MORE_Y: return "messagedata::MoreIconY";
		...
		case MESSAGEDATA_ICON_SCROLLDOWN_ANCHOR: return "messagedata::ScrollDownIconAnchor";
		case MESSAGEDATA_ICON_SCROLLDOWN_SPRITE: return "messagedata::ScrollDownIconSprite";
		case MESSAGEDATA_ICON_SCROLLDOWN_X: return "messagedata::ScrollDownIconX";
		case MESSAGEDATA_ICON_SCROLLDOWN_Y: return "messagedata::ScrollDownIconY";
		case MESSAGEDATA_SCROLL_SPEED_ACTIVE: return "messagedata::ScrollSpeedActive";
		case MESSAGEDATA_SCROLL_SPEED_PASSIVE: return "messagedata::ScrollSpeedPassive";
		case MESSAGEDATA_ICON_SCROLLUP_ANCHOR: return "messagedata::ScrollUpIconAnchor";
		case MESSAGEDATA_ICON_SCROLLUP_SPRITE: return "messagedata::ScrollUpIconSprite";
		case MESSAGEDATA_ICON_SCROLLUP_X: return "messagedata::ScrollUpIconX";
		case MESSAGEDATA_ICON_SCROLLUP_Y: return "messagedata::ScrollUpIconY";
		case MESSAGEDATASEGMENTS: return "messagedata::Segments[]";
		case MESSAGEDATA_SHADOW_COLOR: return "messagedata::ShadowColor";
		case MESSAGEDATA_SHADOW_TYPE: return "messagedata::ShadowType";
		case MESSAGEDATASFX: return "messagedata::Sound";
		case MESSAGEDATA_ADVSFX: return "messagedata::SoundAdvance";
		case MESSAGEDATA_MENUCLOSE_SFX: return "messagedata::SoundMenuClose";
		case MESSAGEDATA_MENUMOVE_SFX: return "messagedata::SoundMenuMove";
		...
		case NPCDEATHEXSTATE: return "npc::DeathExState";
		...
		case NPCPARENTUID: return "npc::Parent";
		case NPC_SUMMONER_PARENT: return "npc::ParentSummoner";
		...
		case NPC_WEAPONDATA: return "npc::WeaponData";
		...
		case NPCDATA_WEAPONDATA: return "npcdata::WeaponData";
		...
		case SAVEMENU_MISCTEXT_TEXT_ALIGN: return "save_menu::MiscTextAlign[]";
		case SAVEMENU_MISCTEXT_COLOR: return "save_menu::MiscTextColors[]";
		case SAVEMENU_MISCTEXT_FONT: return "save_menu::MiscTextFonts[]";
		case SAVEMENU_MISCTEXT_SHADOW_COLOR: return "save_menu::MiscTextShadowColors[]";
		case SAVEMENU_MISCTEXT_SHADOW_TYPE: return "save_menu::MiscTextShadowTypes[]";
		case SAVEMENU_MISCTEXT_X: return "save_menu::MiscTextX[]";
		case SAVEMENU_MISCTEXT_Y: return "save_menu::MiscTextY[]";
		case SAVEMENU_MUSIC: return "save_menu::Music";
		case SAVEMENU_NUM_MISCTEXTS: return "save_menu::NumMiscTexts";
		...
		case SAVEMENU_OPT_COLOR_SHADOW_PICKED: return "save_menu::PickedShadowColors[]";
		case SAVEMENU_SFX_CHOOSE: return "save_menu::SFXChoose";
		case SAVEMENU_SFX_CURSOR: return "save_menu::SFXCursor";
		case SAVEMENU_SEL_OPT_OFFSET_X: return "save_menu::SelectedXOffset";
		case SAVEMENU_SEL_OPT_OFFSET_Y: return "save_menu::SelectedYOffset";
		case SAVEMENU_OPT_COLOR_SHADOW: return "save_menu::ShadowColors[]";
		case SAVEMENU_OPT_SHADOW_TYPE: return "save_menu::ShadowTypes[]";
		...
		case SPRITE_INVIS_CLK: return "sprite::InvisibleTimer";
		case SPRITE_JUMP: return "sprite::Jump";
		case SPRITE_LIGHT_OFFSET: return "sprite::LightOffset";
		...
		case SPRITE_NOCOLL_CLK: return "sprite::NoCollisionTimer";
		...
		case SPRITE_VIEWPORT_DESPAWN_RANGE: return "sprite::ViewportDespawnRange";
		case SPRITE_VIEWPORT_SUSPEND_RANGE: return "sprite::ViewportSuspendRange";
		...
		case SUBWIDGTY_COLOR_UNVISITED: return "subscreenwidget::ColorUnvisited";
		...
		case WEAPDATA_BOUNCE_ADD: return "weapondata::BounceAdd";
		case WEAPDATA_BOUNCE_MULT: return "weapondata::BounceMult";
		case WEAPDATA_BURN_LIGHTOFFSET: return "weapondata::BurnLightOffset[]";
		case WEAPDATA_BURN_LIGHTRAD: return "weapondata::BurnLightRadius[]";
		case WEAPDATA_BURN_SPRITES: return "weapondata::BurnSprites[]";
		case WEAPDATA_USEDEFENCE: return "weapondata::Defense";
		case WEAPDATA_X_OFFSET: return "weapondata::DrawXOffset";
		case WEAPDATA_Y_OFFSET: return "weapondata::DrawYOffset";
		case WEAPDATA_WEAP_FLAGS: return "weapondata::Flags[]";
		case WEAPDATA_HIT_HEIGHT: return "weapondata::HitHeight";
		case WEAPDATA_HIT_WIDTH: return "weapondata::HitWidth";
		case WEAPDATA_HIT_OFFSET_X: return "weapondata::HitXOffset";
		case WEAPDATA_HIT_OFFSET_Y: return "weapondata::HitYOffset";
		case WEAPDATA_HIT_ZHEIGHT: return "weapondata::HitZHeight";
		case WEAPDATA_INITD: return "weapondata::InitD[]";
		case WEAPDATA_LIFTHEIGHT: return "weapondata::LiftHeight";
		case WEAPDATA_LIFTLEVEL: return "weapondata::LiftLevel";
		case WEAPDATA_LIFTTIME: return "weapondata::LiftTime";
		case WEAPDATA_LIGHT_SHAPE: return "weapondata::LightShape";
		case WEAPDATA_MISC_FLAGS: return "weapondata::MiscFlags[]";
		case WEAPDATA_MOVE_FLAGS: return "weapondata::MoveFlags[]";
		case WEAPDATA_PIERCE: return "weapondata::PierceCount";
		case WEAPDATA_SCRIPT: return "weapondata::Script";
		case WEAPDATA_SIZE_BITFLAGS: return "weapondata::SizeFlags";
		case WEAPDATA_STEP: return "weapondata::Step";
		case WEAPDATA_TILE_H: return "weapondata::TileHeight";
		case WEAPDATA_TILE_W: return "weapondata::TileWidth";
		case WEAPDATA_TIMEOUT: return "weapondata::Timeout";
		case WEAPDATA_UNBLOCKABLE: return "weapondata::Unblockable";
		case WEAPDATA_VALID: return "weapondata::Valid";
		case WEAPDATA_VIEWPORT_DESPAWN_RANGE: return "weapondata::ViewportDespawnRange";
		case WEAPDATA_VIEWPORT_SUSPEND_RANGE: return "weapondata::ViewportSuspendRange";
		case WEAPDATA_USEWEAPON: return "weapondata::Weapon";
...
const char* scripting_get_zasm_command_context_string(ASM_DEFINE command)
{
	switch (command)
	{
		...
		case DRAWMAPDATA: return "Screen->DrawMapdata()";
		case DRAWMINITILE: return "Screen->DrawMiniTile()";
		...
		case BMPDRAWMAPDATA: return "bitmap::DrawMapdata()";
		case BMPDRAWMINITILE: return "bitmap::DrawMiniTile()";
		...
		case FFCTRIGGER: return "ffc::Trigger()";
		...
		case NPC_SUMMON_MINION: return "npc::SummonMinion()";
		case NPC_SUMMON_MINION_LAYER: return "npc::SummonMinionFromLayer()";
		...
		case SAVEMENU_ADD_MISCTEXT: return "save_menu::AddMiscText()";
		case SAVEMENU_ADD_OPT: return "save_menu::AddOption()";
		case SAVEMENU_MISCTEXT_GET_STRING: return "save_menu::GetMiscTextString()";
		...
		case SAVEMENU_REMOVE_MISCTEXT: return "save_menu::RemoveMiscText()";
		case SAVEMENU_REMOVE_OPT: return "save_menu::RemoveOption()";
		case SAVEMENU_MISCTEXT_SET_STRING: return "save_menu::SetMiscTextString()";
		case SAVEMENU_SETNAME: return "save_menu::SetName()";
		case SAVEMENU_OPT_SET_STRING: return "save_menu::SetString()";
		case SAVEMENU_SWAP_MISCTEXT: return "save_menu::SwapMiscTexts()";
		...
		case WEAPDATA_APPLY: return "weapondata::ApplyTo()";
		case WEAPDATA_COPY: return "weapondata::CopyTo()";
		case CREATEWEAPDATA: return "weapondata::weapondata()";
