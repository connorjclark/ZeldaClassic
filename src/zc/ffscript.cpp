...
int32_t get_register(int32_t arg)
{
	...
	//BottleTypes
		...
		case COMBOXR:
		{
			...
			{
				scripting_log_error_with_context("Can only be called by combodata scripts, but you tried to use it from script type {}, script token {}", ScriptTypeToString(curScriptType), comboscriptmap[GET_COMBOREF].scriptname);
				ret = -10000;
			}
			break;
		}
		...
		case COMBOYR:
		{
			...
			{
				scripting_log_error_with_context("Can only be called by combodata scripts, but you tried to use it from script type {}, script token {}", ScriptTypeToString(curScriptType), comboscriptmap[GET_COMBOREF].scriptname);				ret = -10000;
			}
			break;
		}
		case COMBOPOSR:
