...
extern int digi_volume,midi_volume,sfx_volume,emusic_volume,currmidi,hasitem,whistleclk,pan_style,vol_mute;
extern int digi_volume_buf,midi_volume_buf,sfx_volume_buf,emusic_volume_buf;
