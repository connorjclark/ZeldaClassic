...
int digi_volume = 0,midi_volume = 0,sfx_volume = 0,emusic_volume = 0,currmidi = 0,hasitem = 0,whistleclk = 0,pan_style = 0,vol_mute = 0;
int digi_volume_buf = 0,midi_volume_buf = 0,sfx_volume_buf = 0,emusic_volume_buf = 0;
