...
{
	{ "(None)", edNORMAL },
	{ "1/2 Damage", edHALFDAMAGE },
	{ "1/4 Damage", edQUARTDAMAGE },
	{ "Stun", edSTUNONLY },
	{ "Stun Or Block", edSTUNORCHINK },
	{ "Stun Or Ignore", edSTUNORIGNORE },
	{ "Block If < 1", edCHINKL1 },
	{ "Block If < 2", edCHINKL2 },
	{ "Block If < 4", edCHINKL4 },
	{ "Block If < 6", edCHINKL6 },
	{ "Block If < 8", edCHINKL8 },
	{ "Block", edCHINK },
	{ "Ignore If < 1", edIGNOREL1 },
	{ "Ignore", edIGNORE },
	{ "One-Hit-Kill", ed1HKO },
	{ "Block if Power < 10", edCHINKL10 },
	{ "Double Damage", ed2x },
	{ "Triple Damage", ed3x },
	{ "Quadruple Damage", ed4x },
	{ "Enemy Gains HP = Damage", edHEAL },
	{ "Trigger Screen Secrets", edTRIGGERSECRETS },
	// { "-freeze", edFREEZE },
	// { "-msgnotenabled", edMSG_NOT_ENABLED },
	// { "-msgline", edMSG_LINE }, 
	// { "-lvldamage", edLEVELDAMAGE },
	// { "-lvlreduction", edLEVELREDUCTION },
	{ "Split", edSPLIT },
	{ "Transform", edREPLACE },
	// { "-lvlblock2", edLEVELCHINK2 },
	// { "-lvlblock3", edLEVELCHINK3 },
	// { "-lvlblock4", edLEVELCHINK4 }, 
	// { "-lvlblock5", edLEVELCHINK5 },
	// { "-shock", edSHOCK },
	{ "Bomb Explosion", edEXPLODESMALL },
	{ "Superbomb Explosion", edEXPLODELARGE },
	// { "-deadrock", edSTONE },
	// { "-breakshoeld", edBREAKSHIELD },
	// { "-restoreshield", edRESTORESHIELD },
	// { "-specialdrop", edSPECIALDROP },
	// { "-incrcounter", edINCREASECOUNTER },
	// { "-reducecounter", edREDUCECOUNTER },
	{ "Harmless Explosion", edEXPLODEHARMLESS },
	// { "-killnosplit", edKILLNOSPLIT },
	// { "-tribble", edTRIBBLE },
	// { "-fireball", edFIREBALL },
	// { "-fireballlarge", edFIREBALLLARGE },
	{ "Summon", edSUMMON },
	// { "-wingame", edWINGAME },
	// { "-jump", edJUMP },
	// { "-eat", edEATHERO },
	// { "-showmessage", edSHOWMESSAGE },
	{ "Switch w/ Player", edSWITCH },
};
