...
// folder up, so only the one just installed is worth keeping. Only loose files are
// removed: ZC_UPDATER_CACHE_FOLDER can name any folder, and recursing into it is
// more than this is owed.
