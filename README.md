...
Zelda Classic builds Allegro 5 from source. The code base still uses Allegro 4 APIs, but uses [Allegro-Legacy](https://github.com/NewCreature/Allegro-Legacy) to transalte into Allegro 5.
...
Binaries will be created in the `build` folder. You will need to copy the data files created by the buildback.sh script to the Debug/Release folders.
