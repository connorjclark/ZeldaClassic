# https://jameskr.dev/en/2020/09/my-crashpad-experience/
# With some modifications. Mainly, using `fetch` directly from cmake.
...
ExternalProject_Add(crashpad_init
    ...
    # BUILD_IN_SOURCE 1
    BUILD_ALWAYS 1
    # BUILD_BYPRODUCTS ${OUTPUT_LIBS}

	DOWNLOAD_COMMAND ${EXE_DEPOT_FETCH} crashpad || true
    # DOWNLOAD_COMMAND ""
    # CONFIGURE_COMMAND ""
    # BUILD_COMMAND ""
    CONFIGURE_COMMAND ""
	# CONFIGURE_COMMAND ${EXE_DEPOT_GN} gen ${BINARY_DIR} "--args=target_cpu=\"${GN_TARGET_CPU}\" is_debug=${GN_IS_DEBUG} extra_cflags=\"${GN_WIN_LINK_FLAG}\""
    BUILD_COMMAND ""
	INSTALL_COMMAND ""
	TEST_COMMAND ""
)
...
ExternalProject_Add_Step(crashpad_init gn_configure
	...
	ALWAYS 1
	# USES_TERMINAL 1
	WORKING_DIRECTORY ${SOURCE_DIR}/crashpad
    # DEPENDEES download
...
ExternalProject_Add_StepTargets(crashpad_init gn_configure)
...
target_include_directories(crashpad INTERFACE ${SOURCE_DIR}/crashpad)
target_include_directories(crashpad INTERFACE ${SOURCE_DIR}/crashpad/third_party/mini_chromium/mini_chromium)
target_include_directories(crashpad INTERFACE ${BINARY_DIR}/gen)
